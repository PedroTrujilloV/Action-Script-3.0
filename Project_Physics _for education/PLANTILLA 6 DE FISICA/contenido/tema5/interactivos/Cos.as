...
import fl.controls.*
import flash.text.*
public class Cos extends MovieClip
    {	
	...
	public var barVal:Slider = new Slider(); 
	public var formatext:TextFormat = new TextFormat() 
	public var textFunCos,textXRad,textXgrad,textY:TextField
	public function Cos()
	   {
	   iniciar();
	   }	   
	public function iniciar():void
	   {			
		...
		//-----Plano principal para grafica coseno
		...
		for(var i1:int = 0; i1<=560; i1++)
			...
			xpos = 200 + i1;            
			ypos = 100 - (50*Math.cos(angulo));
			conten.graphics.lineTo(xpos, ypos);		
			}
		//------marcas lineas plano coseno
		conten.graphics.lineStyle(1,0x000000,1);
		...
		conten3.graphics.lineTo(160,100)    //la linea que marca el coseno en 0 grados en la circunferencia 
		
		conten4.graphics.lineStyle(1,0xFF0000,1);
		conten4.graphics.moveTo(380, 100)
		conten4.graphics.lineTo(380,50)		//la linea que marca el coseno en 0 grados sobre el plano	
		//valores
		...
		formatext.color = 0xFF0000;
	    textY.text = "1"                    //el texto inicial de los valores de f(x) iniciado en 1  
	...
	*/		
	...
	private function _pinta():void
		...
		conten3.graphics.lineTo(110+50*Math.cos(angulo),100)
		...
		formatext.color = 0xFF0000;
	    textY.text = ""+Math.round(Math.cos(angulo)*Math.pow(10,7))/Math.pow(10,7);
		textY.setTextFormat(formatext);
		formatext.color = 0x1171FF;      
		textXRad.setTextFormat(formatext);
		...
		if( (barVal.value==135)||(barVal.value==225)||(barVal.value==495) )
		   ...
		   valA.visible = true;		  
		    ...
		    if( (barVal.value==150)||(barVal.value==210)||(barVal.value==510) )
		   	  	{
				valB.x = 650;
		   		valB.y = 110;
		   		valB.visible = true;
		   		...
		   		if( (barVal.value==30)||(barVal.value==330)||(barVal.value==390) )
		        	 {
					 valBn.x = 650;
		   			 valBn.y = 100;
		   			 valBn.visible = true;
			    	...
			    	if( (barVal.value==45)||(barVal.value==315)||(barVal.value==405) )
		         		 {
						 valAn.x = 650;
		   			 	 valAn.y = 110;
		   			 	 valAn.visible = true;
