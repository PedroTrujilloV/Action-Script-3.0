package  
{
	...
	public class ondas_index extends MovieClip
	{
		...
		public function configurar_controles():void
		{
			...
			periodo_sld.maximum = 6;
			periodo_sld.minimum = .16;
			...
			frecuencia_sld.maximum = 6;
			frecuencia_sld.minimum = .16;
			...
			periodo_txt.text = "Periodo (T): "+String(Periodo)+"s";
			fase_txt.text = "Fase (θ): "+String(Fase)+"s";
...
//--------------------------
		...
		public function dibujar_coordenadas():void
		{
			...
			for(var i:uint = 0; i<7; i++)
			{
				...
				escalast[i].txt.text =  String(i)+" seg";
			}
