...
import flash.text.*;
//clase
public class MainRestaVectorDos extends MovieClip
	{
	...
	*/
	public function MainRestaVectorDos()
		{
		 _cargaGrilla()	
		}	
	...
	*/	
	...
	private function _pintar():void
		...
		//vector b
		grilla.pintado.graphics.lineStyle(1,0xFF8C8C,1)//estilo de linea
		//grilla.pintado.graphics.moveTo(vector_origen[0],vector_origen[1])//punto de origen
		grilla.pintado.graphics.moveTo(((v[2]-vector_origen[0])*-1)+vector_origen[0],((v[3]-vector_origen[1])*-1)+vector_origen[1])//punto de origen
		grilla.pintado.graphics.lineTo(vector_origen[0],vector_origen[1])//punto de origen
		...
		//vector resultante
		v_s = grilla.restaPosicionesPantallaPlano(v)//se suman las posiciones en pantalla
	...
	*/		
	private function _mostrar():void
		...
		muestra.abx.text = String(Math.round((v_p_pl[0] + (v_p_pl1[0]*-1))*100)/100)
		muestra.aby.text = String(Math.round((v_p_pl[1] + (v_p_pl1[1]*-1))*100)/100)
		}
	/*
